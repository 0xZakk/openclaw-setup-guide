...
Create a plist at `~/Library/LaunchAgents/com.user.nightly-backup.plist`:
...
<dict>
  <key>Label</key>
  <string>com.user.nightly-backup</string>
...
Then load it: `launchctl load ~/Library/LaunchAgents/com.user.nightly-backup.plist`
