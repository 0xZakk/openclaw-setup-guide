...
> **Warning:** Fill in your `.gitignore` before staging or committing anything. If you commit first and add the `.gitignore` later, your API keys, bot tokens, and credentials will already be in the git history -- and removing them after the fact is a pain.
